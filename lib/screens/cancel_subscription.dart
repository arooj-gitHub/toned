...
class CancelSubscription extends StatefulWidget {
  ...
  @override
  State<CancelSubscription> createState() => CancelSubscriptionState();
}

class CancelSubscriptionState extends State<CancelSubscription> {
  ...
  */
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            border: Border.all(width: 1, color: const Color(0xff002366)),
                            borderRadius: const BorderRadius.all(
                              Radius.circular(20),
                            ),
                          ),
              ...
              GestureDetector(
                onTap: () async {
                  ...
                  await StripePayments().cancelSubscription(customerSubscriptionID, context);
                },
                child: Container(
